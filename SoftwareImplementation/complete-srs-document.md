...
|---------------|------------------------|----------|
| USR-01 | ระบบต้องรองรับการลงทะเบียนสมาชิกด้วย:<br>- ชื่อ-นามสกุล<br>- อีเมล (ใช้เป็น Username)<br>- รหัสผ่าน<br> : 
-รหัสผ่านต้องมีความยาว 7-16 ตัว
-มีตัวอักษรพิเศษ 1 ตัว 
- เบอร์โทรศัพท์<br>- ที่อยู่ | High |
